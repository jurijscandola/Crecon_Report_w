...
public class ActionReset implements ActionListener
{
    ...
    public ActionReset(final List<HashMap<String, String>> ls, final JXTable table, final JFrame frame) {
        this.ls = ls;
        this.table = table;
        this.frame = frame;
    ...
    public void actionPerformed(final ActionEvent e) {
        try {
            ...
            JOptionPane.showMessageDialog(this.frame, PropertiesManager.getInstanceOfPropertiesManager().getProperty("RESET"));
        }
